...
class TestElevatorAlgorithm(unittest.TestCase):
    ...
    def test_assign_stop_SWS(self):
        ...
        building = Building(simple_floor_populations, simple_dest_floors_by_state_name, simple_elevator_algorithm, simple_elevator_starting_floors, simple_elevator_capacities, simple_elevator_steps_per_stops, simple_elevator_return_to_floors)
