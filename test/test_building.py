...
class TestBuilding(unittest.TestCase):
    ...
    def test_generation(self):
        simple_building = Building(simple_floor_populations, simple_dest_floors_by_state_name, simple_elevator_algorithm, simple_elevator_starting_floors, simple_elevator_capacities, simple_elevator_steps_per_stops, simple_elevator_return_to_floors)
        HERE_building = Building(HERE_floor_populations, HERE_dest_floors_by_state_name, HERE_elevator_algorithm, HERE_elevator_starting_floors, HERE_elevator_capacities, HERE_elevator_steps_per_stops, HERE_elevator_return_to_floors)
